...
--[[
函数:swscale_struct_swscale_get_table
功能:返回所有需要解析结构体列表
参数:
返回:table
]]--
function swscale_struct_swscale_get_table()
	local tbl={
...
--[[
函数:swscale_struct_swscale_default
功能:读取结构体定义信息
参数:
返回:table
]]--
function swscale_struct_swscale_default(szFileName,szStruct)
	...
	return swscale_struct_swscale_set_default(avcodectbl,szStruct);
end
--[[
函数:swscale_struct_swscale_set_default
功能:对swscale结构体table付初值
参数:
返回:table
]]--
function swscale_struct_swscale_set_default(avcodectbl,szStruct)
...
--[[
函数:swscale_struct_swscale_Repalce
功能:替换该文件中swscale变量
参数:
返回:
]]--
function swscale_struct_swscale_Repalce(szFileName,avcodectbl,szStruct)
