...
--[[
函数:avutil_struct_avutil_get_table
功能:返回所有需要解析结构体列表
参数:
返回:table
]]--
function avutil_struct_avutil_get_table()
	local tbl={
...
--[[
函数:avutil_struct_avutil_default
功能:读取结构体定义信息
参数:
返回:table
]]--
function avutil_struct_avutil_default(szFileName,szStruct)
	...
	return avutil_struct_avutil_set_default(avcodectbl,szStruct);
end
--[[
函数:avutil_struct_avutil_set_default
功能:对avutil结构体table付初值
参数:
返回:table
]]--
function avutil_struct_avutil_set_default(avcodectbl,szStruct)
...
--[[
函数:avutil_struct_avutil_Repalce
功能:替换该文件中avutil变量
参数:
返回:
]]--
function avutil_struct_avutil_Repalce(szFileName,avcodectbl,szStruct)
