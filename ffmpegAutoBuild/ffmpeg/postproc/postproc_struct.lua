...
--[[
函数:postproc_struct_postproc_get_table
功能:返回所有需要解析结构体列表
参数:
返回:table
]]--
function postproc_struct_postproc_get_table()
	local tbl={
...
--[[
函数:postproc_struct_postproc_default
功能:读取结构体定义信息
参数:
返回:table
]]--
function postproc_struct_postproc_default(szFileName,szStruct)
	...
	return postproc_struct_postproc_set_default(avcodectbl,szStruct);
end
--[[
函数:postproc_struct_postproc_set_default
功能:对postproc结构体table付初值
参数:
返回:table
]]--
function postproc_struct_postproc_set_default(avcodectbl,szStruct)
...
--[[
函数:postproc_struct_postproc_Repalce
功能:替换该文件中postproc变量
参数:
返回:
]]--
function postproc_struct_postproc_Repalce(szFileName,avcodectbl,szStruct)
